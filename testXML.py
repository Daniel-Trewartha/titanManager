...
ET.SubElement(job1,"jobname").text = 'testJob1'
ET.SubElement(job1,"nodes").text = str(1)
ET.SubElement(job1,"wallTime").text = '00:10:00'
ET.SubElement(job1,"executionCommand").text = "pwd"
ET.SubElement(job1,"outputCheckCommand").text = "pwd"
ET.SubElement(job1,"outputCheckLoc").text = os.path.abspath(__file__)
...
ET.SubElement(job2,"jobname").text = 'testJob2'
ET.SubElement(job2,"nodes").text = str(1)
ET.SubElement(job2,"wallTime").text = '00:10:00'
ET.SubElement(job2,"executionCommand").text = "pwd"
ET.SubElement(job2,"outputCheckCommand").text = "pwd"
ET.SubElement(job2,"outputCheckLoc").text = os.path.abspath(__file__)
